define(function(require, exports, module) {
	...
	var bs = {
		...
		add: function(saveSQXX,saveStatus){
			//TODO 将formData提交到后台动作上
			return BH_UTILS.doAjax('../modules/sqxx/tjsqxx.do', {
				saveSQXX:saveSQXX,
				saveStatus:saveStatus});
			
		},
		save: function(saveSQXX,saveStatus){
			//TODO 将formData提交到后台动作上
			return BH_UTILS.doAjax('../modules/sqxx/zxtjsqxx.do', {
				saveSQXX:saveSQXX,
				saveStatus:saveStatus});
		},
		del: function(params){
			//TODO 添加删除动作
//			return BH_UTILS.doAjax('../modules/sqxx/T_PXXX_XSJBXX_DELETE.do', {
