    ...
    var viewConfig = {
            initialize: function(sqbh) {
        		...
        		case '1':
                    ...
                    var data3 = WIS_EMAP_SERV.getData(bs.api.pageModel, 'asjcxstzdlsspxx', {SQBH:sqbh}).rows[0];
            		$("#emapForm2").emapForm("setValue", data3);
                    ...
                    var data4 = WIS_EMAP_SERV.getData(bs.api.pageModel, 'asjcxtwfzrspxx', {SQBH:sqbh}).rows[0];
            		$("#emapForm3").emapForm("setValue", data4);
            		var data5 = WIS_EMAP_SERV.getData(bs.api.pageModel, 'asjcxbwcspxx', {SQBH:sqbh}).rows[0];
        			var mode4 = WIS_EMAP_SERV.getModel(bs.api.pageModel, 'T_CDSQ_BWCSP_QUERY', 'form');
    				$("#emapForm4").emapForm({
                        data: mode4,
                        model: 'h',
                    ...
                    $("#emapForm4").emapForm("setValue", data5);
            		if (data2.DQZT>'7'&&data4.SFJP=='1') {
            			var data6 = WIS_EMAP_SERV.getData(bs.api.pageModel, 'asjcxbwcldspxx', {SQBH:sqbh}).rows[0];
            			var mode5 = WIS_EMAP_SERV.getModel(bs.api.pageModel, 'T_CDSQ_BWCLDSP_QUERY', 'form');
        				$("#emapForm5").emapForm({
                            data: mode5,
                            model: 'h',
                        ...
                        $("#emapForm5").emapForm("setValue", data6);
            		}
            		break;
        		case '2':
                    ...
                    var data3 = WIS_EMAP_SERV.getData(bs.api.pageModel, 'asjcxaqfzrspxx', {SQBH:sqbh}).rows[0];
            		$("#emapForm2").emapForm("setValue", data3);
