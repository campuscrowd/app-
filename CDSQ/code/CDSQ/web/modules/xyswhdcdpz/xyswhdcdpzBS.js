define(function(require, exports, module) {
	...
	var bs = {
		api: {
			pageModel: 'modules/xyswhdcdpz.do',
		...
		save: function(formData){
			...
			return BH_UTILS.doAjax('../modules/xyswhdcdpz/T_CDSQ_CDXX_SAVE.do', formData);
		},
		del: function(params){
			//TODO 添加删除动作
			return BH_UTILS.doAjax('../modules/xyswhdcdpz/T_CDSQ_CDXX_DELETE.do', {
				T_CDSQ_CDXX_DELETE:JSON.stringify(params)
			});
		},
		open: function(id){
			//TODO 添加删除动作
			return BH_UTILS.doAjax('../modules/xyswhdcdpz/T_CDSQ_CDXX_MODIFY.do', {
				WID:id,
				SFKF:'1'
			});
		},
