define(function(require, exports, module) {
    ...
    var viewConfig = {
            initialize: function(sqbh) {
                ...
                var mode3 = WIS_EMAP_SERV.getModel(bs.api.pageModel, 'asjcxstzdlsspxx', 'form');
                var data3 = WIS_EMAP_SERV.getData(bs.api.pageModel, 'asjcxstzdlsspxx', { SQBH: sqbh });
                if (data2.DQZT>'3') {
    				$("#emapForm2").emapForm({
                        data: mode3,
                        model: 'h',
                ...
                var mode4 = WIS_EMAP_SERV.getModel(bs.api.pageModel, 'asjcxtwfzrspxx', 'form');
                var data4 = WIS_EMAP_SERV.getData(bs.api.pageModel, 'asjcxtwfzrspxx', { SQBH: sqbh });
                if (data2.DQZT>'5') {
    				$("#emapForm3").emapForm({
                        data: mode4,
                        model: 'h',
                    ...
                    $("#emapForm3").emapForm("setValue", data4.rows[0]);
                }
