define(function(require, exports, module) {
	...
	var bs = {
		api: {
			pageModel: 'modules/ssyxxgcldsp.do',
		...
		save: function(saveSPXX,saveStatus){
			...
			return BH_UTILS.doAjax('../modules/ssyxxgcldsp/tjxgcldsp.do', {
				saveSPXX:saveSPXX,
		...
		del: function(params){
			//TODO 添加删除动作
//			return BH_UTILS.doAjax('../modules/ssyxxgcldsp/T_PXXX_XSJBXX_DELETE.do', {
